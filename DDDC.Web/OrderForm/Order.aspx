<%@ Page Title="" Language="C#" MasterPageFile="~/OrderForm/OrderMasterPage.master" AutoEventWireup="true" CodeFile="Order.aspx.cs" Inherits="OrderForm_Order" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="main-container">
        ...
        <section class="order-info">
            ...
            <!-- 最大成员数 -->
            <div class="form-group">
                <label for="txtMaxCapacity">人员载荷:</label>
                <asp:TextBox ID="txtMaxCapacity" runat="server" CssClass="form-input" ReadOnly="True"></asp:TextBox>
            </div>
            ...
            <div class="form-action">
                <asp:Button ID="btnSubmitOrder" runat="server" Text="提交订单" CssClass="submit-button" OnClick="btnSubmitOrder_Click" />
            </div>
        </section>
    ...
    <asp:TextBox ID="txtPrice" runat="server" CssClass="form-input" ReadOnly="true" Enabled="false" Placeholder="自动计算路程"></asp:TextBox>
    ...
    <script type="text/javascript">
        ...
        function calculateAndDisplayRoute() {
            var currentPosition = "<%= Session["CHere"] %>"; // 获取Session中的当前位置
        var destination = document.getElementById('<%= txtDestination.ClientID %>').value; // 获取目的地输入框内容
                ...
                if (startPoint) {
                    ...
                    geocoder.getPoint(destination, function (endPoint) {
                        if (endPoint) {
                            ...
                            document.getElementById('<%= HiddenPrice.ClientID %>').value = distanceText;
