<%@ Page Title="" Language="C#" MasterPageFile="~/FinishOrder/MasterPage.master" AutoEventWireup="true" CodeFile="CheckFinishedOrder.aspx.cs" Inherits="FinishOrder_CheckFinishedOrder" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="order-info">
        ...
        <div class="info-group">
            ...
            <asp:TextBox ID="txtDriverPhone" runat="server" ReadOnly="True"></asp:TextBox>
        </div>
        <div class="info-group">
            <label for="prePosition">当前位置:</label>
        ...
        <div class="progress-container">
            ...
            <div class="progress-status">状态: 订单已完成</div>
        </div>

        <asp:Button ID="btnCompleteOrder" runat="server" Text="订单已完成" CssClass="complete-button1" Enabled="false"/>
        <asp:Button ID="btncheckOrder" runat="server" Text="查看订单" CssClass="complete-button" OnClick="btncheckOrder_Click" />
    </div>
</div>
</asp:Content>
