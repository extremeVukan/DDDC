<%@ Page Title="" Language="C#" MasterPageFile="~/FinishOrder/MasterPage.master" AutoEventWireup="true" CodeFile="DriverFinishOrder.aspx.cs" Inherits="FinishOrder_DriverFinishOrder" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="order-info">
        ...
        <div class="progress-container">
            ...
            <div class="progress-status">状态: 订单完成</div>
        </div>
